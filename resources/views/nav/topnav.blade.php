        ...
        <div class="navbar-collapse header-overlay" id="main-top-nav-bar">
            ...
            <ul class="navbar-nav navbar-top-right my-lg-0" id="right-topnav-navbar">
                ...
                <!--notifications -->
                                ...
                                <li class="nav-item">
                                    <a class="nav-link waves-effect waves-dark font-22 p-t-9 p-r-10 edit-add-modal-button js-ajax-ux-request reset-target-modal-form" href="#" id="32"
                                        data-toggle="modal" data-target="#commonModal" data-modal-title="@lang('lang.record_your_work_time')"
                                        data-url="{{ url('/timesheets/create') }}"
                                        data-action-url="{{ urlResource('/timesheets') }}"
